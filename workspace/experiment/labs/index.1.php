   ...
   <body>
	...
	<div class="row text-center">
	   <br><br><br> <br><br><br><br><br><br> <br><br><br>
		<center><h3 class="headtext">Explore The New World of Creativity</h3></center>
        <p class="para">Contrary to popular belief, Lorem Ipsum is not simply random text.</p>
        <br><br>
        ...
        <div class="container">
         <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <center> <h3 class="para1">A DIGITAL STUDIO CRAFTING BEAUTIFUL   EXPERIENCES.</h3></center>
                    <center><p class="normaltxt">Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Proin gravida nibh vel velit auctor Aenean </p></center>
               </div>
               </div>
               <div class="row">
                  <div class="col-sm-4"> 
                  <div class="box">
                     <i class="fa fa-mobile icon-font"></i>
                    <center> <h5 class="box1">Strategy Solutions</h5></center>
                    <center> <p class="normaltxt">We put a lot of effort in design, as it’s the most important ingredient of successful website.</p> </center>
                  </div>
                    ...
                    <i class="fa fa-pencil-square-o icon-font"></i>
                       <center> <h5 class="box1">Dedicated Support</h5></center>
                          <center> <p class="normaltxt">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat website.</p> </center>
                  </div>
                    </div>
                      <div class="col-sm-4">
                         <div class="box">
                <i class="fa fa-lightbulb-o icon-font"></i>
                       <center> <h5 class="box1">Digital Design</h5></center>
                          <center> <p class="normaltxt">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry.</p> </center>
                  </div>
                      </div>
               </div>
               </div>
...
<div class="video">
    <video class="thevideo" loop preload="none">
      <source src="https://www.youtube.com/embed/N9hXX5DlwC8" type="video/mp4">
      
      <source src="https://www.youtube.com/embed/N9hXX5DlwC8" type="video/webm">
