...
<html lang="en">
  <head>
    ...
    <script src="../js/Validation.js" type="text/javascript"></script>
     <meta content="width=device-width, initial-scale=1" name="viewport"><!--[if lte IE 11]>
<div id="warning">
<META http-equiv="refresh" content="0;URL=https://mss-templete-sivanmyc.c9.io/experiment/2modals.php">
</div><-->
    <!--[if lt IE 9]>
             ...
             <div class="modal-header">
              ...
              <h3 class="modal-title" id="memberModalLabel">
               ...
               <hr>
                ...
                <div class="row modal-footer noMargin">
                      
                 <div class="col-sm-6"><a href="../library/index.php"><button class="btn btn-primary col-sm-12">
                  ...
                  <div class="back" id="formDiv">
                   ...
                   <div class="row">
                    ...
                    <!--copy 1 from contact first row starts-->
                      ...
                      <input class="form-control col-sm-12" id="firstname" name="firstname" placeholder="First Name*" required="required" type="text">
                       </div>
                       
                       </div>
                       <div class="col-sm-6">
                       <div class="form-group">
                         <input class="form-control col-sm-12" placeholder="Last Name*" required="required" type="text">
                       </div>
                       </div>
                       </div>
                       <div class="row">
                   ...
                   <div class="tab-pane " id="emplyolee-sign-in">
                     ...
                     <div class="row">
                        <div class="col-sm-11"><button type="submit" tabindex="3" class="btn btn-primary col-md-6" name="btnSubmit" id="btnSubmit">
                                    Log In
                                </button></div>
                                <div class="col-sm-1"></div>
                     </div>
