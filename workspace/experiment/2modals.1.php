...
<html lang="en">
  <head>
    ...
    <title>
     Content Syndication
		...
		<link rel="stylesheet" type="text/css" href="m-css/slit.css" />
  ...
  <div class="modal fade" id="demo-1" tabindex="1" data-backdrop= "static" data-keyboard= "false">
       ...
       <div class="modal-footer ">
           ...
           <div class="row noMargin">
               ...
               <div class="col-sm-6"> <a href="../libray/index.php"><button type="button" class="btn btn-primary col-sm-12 "   >Go to Library</button></a></div>
                <div class="col-sm-6">
            <button type="button" class="btn btn-primary col-sm-12" class="md-close" data-toggle="modal" data-target="#demo-2" data-dismiss="modal">Access</button></div>
  ...
  <!-- [ Modal #2 ] -->
  <div class="modal fade" id="demo-2" tabindex="1" data-backdrop= "static" data-keyboard= "false">
    <div class="modal-dialog">
     <div class="modal-content">
     <div class="modal-header">
                         ...
                         <div class="form-group">
                          ...
                          <div class="col-sm-6">
                           ...
                           <input class="form-control" placeholder="Work Phone*" required="required" type="text">
                            ...
                            <div class="col-sm-6"><button type="button" class="btn btn-primary col-sm-12" class="md-close" data-toggle="modal" data-target="#demo-1" data-dismiss="modal"><i class="fa fa-arrow-left" ></i>Back to Description</button></div>
