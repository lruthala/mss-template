        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="row noMargin">
                    ...
                    <div class="col-sm-4"></div>
                    <div class="col-sm-4"> <button class="btn btn-primary btn-md noMarginTop" type="button" data-dismiss="modal">Continue</button></div>
                </div>
        ...
        <section class="no-margin responsive" id="main-slider">
            <div class="carousel slide ">
                 <div class="carousel-inner">
                      <div class="item active img-responsive" style="background-image: url(images/slider/banner4.png)">
                       <div class="container">
                            <div class="row">
                                <div class="col-sm-1"></div>
                                <div class="col-sm-9">
                                    ...
                                    <div class="carousel-content centered">
                                        ...
                                        <h1 class="heavy animation animated-item-1">
                                           Want to Learn Node.JS and More?<br>Pre-Conference Workshop@Interconnect 2016</h1>
                                        <p class="heavy animation animated-item-2">
                                            February 21st, 2016 at the Mandalay Bay Hotel and Resort
                                        </p>
                                      
                                        <a class="btn btn-md animation animated-item-3" href="../events/interconnect-2016.php">Limited Seats, Register Today!</a>
                                    <br><br>
                                    </div>
                                </div>
                       ...
                       <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">
                                           IBM Interconnect is Back <br> February 21st‐25th, 2016 | Las Vegas
                                        </h1>
                                       <h6 class="heavy animation animated-item-2">
                                          Meet us at Booth #402
                                        </h6>
                                       <a class="btn btn-md animation animated-item-3" href="events/interconnect-2016.php">Register</a>
                                    <br><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="carousel-content centered">
                                        ...
                                        <h1 class="heavy animation animated-item-1">
                                           ...
                                           IBM PartnerWorld Leadership Conference <br> February 15-18th, 2016 Orlando | Florida
                                        </h1>
                                       
                                        <p class="heavy animation animated-item-2">
                                          Leading Together in the Cognitive Era
                                        </p>
                                       
                                        <a class="btn btn-md animation animated-item-3" TARGET="_blank" href="https://www-304.ibm.com/partnerworld/wps/servlet/ContentHandler/pw_com_pwp-partnerworld-leadership-conference-2016">Register</a>
                                    <br><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="carousel-content centered">
                                        ...
                                        <h1 class="heavy animation animated-item-1">
                                           ...
                                           Technical Webinar : Creating the Complete Retail Solution = Commerce, OMS and IIB
                                        </h1>
                                       
                                        <p class="heavy animation animated-item-2">
                                           Join us on February 10th, 2016 (Wednesday) at 1 PM EST
                                        </p>
                                       
                                        <a class="btn btn-md animation animated-item-3" href="http://www.miraclesoft.com/events/webinar-before.php?eventId=79">Register</a>
                                    <br><br>
                                    </div>
                                </div>
            ...
            <div class="row">
              <div class="col-sm-7">
                 ...
                 <br> <a href="../why/"><button type="button" class="btn btn-danger btn-md">Read More</button></a>
                  ...
                  <p class="methodText">Interconnect 2015 was a combination of 3 major IBM conferences(Pulse, Innovate and Impact) and it did not fail its expectations. Technology rocked Vegas with IBM'ers, Business Partners and Customer all coming together for this massive 4-day event. We ourselves had a great time at the event and are already looking forward to the 2016 edition. Informative Keynotes, Mind-Boggling General Session Speakers and a bucket load of Rock & Roll with Aerosmith all helped to make Interconnect 2015 a memorable event. There were some major announcements from IBM that year including some major technological break-throughs.</p>
                 <br> <a href="../events/interconnect-2015.php"><button type="button" class="btn btn-danger btn-md">Read More</button></a>
              </div>
              <div class="col-sm-5">
                  </br>
