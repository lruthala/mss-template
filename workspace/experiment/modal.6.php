...
.modal button{margin-left:0px; !important;}
...
.blur {
    -webkit-filter: blur(45px) grayscale(80%);
}
...
<div class="modal fade modal-lg" id="myModal"  tabindex="-1" role="dialog" aria-labelledby="memberModalLabel" aria-hidden="true">
           ...
           <div class="flipper">
            ...
            <!-- front content -->
             <div class="modal-header">
                             <button type="button" id="abc" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              ...
              <div class="modal-body">
               <hr>
                ...
                <hr>
                <div class="row">
                 <div class="col-sm-6"><a href="https://mss-templete-sivanmyc.c9.io/library/index.php"><button class="btn btn-primary col-sm-12">Back To Library</button></a></div>
                  <div class="col-sm-6"> <button class="btn btn-primary col-sm-12" onclick="document.querySelector('#flip-toggle').classList.toggle('hover');">Access</button></div>
                 </div>
                  </div>
                  </div>
                  <div class="back" id="formDiv">
                   ...
                   <div class="modal-header">
                    <h3 class="modal-title" id="memberModalLabel">
                    <strong>Sign Up For Access</strong>
                    </h3>
                    <hr>
                     </div>
                      ...
                      <input class="form-control" style="width: 245px;" id="firstname" name="firstname" placeholder="First Name*" required="required" type="text">
                       ...
                       <div class="row">
                         ...
                         <div class="form-group">
                          ...
                          <div class="col-sm-6">
                           ...
                           <input class="form-control" style="width: 245px;" placeholder="Work Phone*" required="required" type="text">
                            ...
                            <div class="col-sm-12">
                            <div class="form-group">
                            <input type="button" id="abc" class="btn btn-primary col-sm-12" id="btnSubmit" name="btnSubmit" tabindex="12" type="submit" value="Submit">
                            </div>
                            </div>
                            </div>
                            <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6"><button class="btn btn-primary btn-lg col-sm-12" onclick="document.querySelector('#flip-toggle').classList.toggle('hover');">
                           <span> <i class="fa fa-arrow-left" ></i> </span>
                           Back To Description
                          </button></div>
                          <div class="col-sm-6"><a href="https://mss-templete-sivanmyc.c9.io/library/index.php"><button class="btn btn-primary btn-lg col-sm-12">Back To Library</button></a></div>
                        </div>
