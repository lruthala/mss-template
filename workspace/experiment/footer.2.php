        ...
        <div class="container">
            <div class="row"> <br>
                <div class="col-md-4 col-sm-6">
                    <h4 class="noMargin foot-color">Recent Articles</h4>
                    <div class="row">
                        <div class="col-sm-3 noMargin foot-color">
                            <hr>
                        </div>
                    </div>
                    <a class="noMargin foot-color" href="../library/scc-product-brief.php"><strong>Enhanced MFT Visibility and Control</strong><br>with IBM Sterling Control Center</a>
                    <div class="greyText noMargin foot-color">
                        B2B Integration and MFT
                    </div>
                    <br>
                    <a class="noMargin foot-color" href="../library/faq-mq.php"><strong>The 10 things that you need to know</strong><br>about IBM's new MQ Appliance</a>
                    <div class="greyText noMargin foot-color">
                        SOA and Connectivity
                    </div>
                    <br>
                    <a class="noMargin foot-color" href="../why/sstory7.php"><strong>Enhanced Visibility and Control</strong><br>for Global Food Distributor</a>
                    <div class="greyText noMargin foot-color">
                        B2B Integration and MFT
                    </div>
                </div>
                ...
                <div class="col-md-2 col-sm-6">
                    <h4 class="noMargin foot-color">Team Miracle</h4>
                    <div class="row">
                        <div class="col-sm-5 noMargin foot-color">
                            <hr>
                        </div>
                    </div>
                    <div>
                ...
                <div class="col-md-3 col-sm-6">
                    <h4 class="noMargin foot-color">Opportunities</h4>
                    <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <h4 class="noMargin foot-color">Corporate HQ</h4>
                    <div class="row">
                            <hr>
                        </div>
                    </div>
