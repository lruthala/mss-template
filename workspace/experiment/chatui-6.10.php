 ...
 <div class="container">
    ...
    <div  class="row chat-window col-xs-5 col-md-3 rude chat-box" id="chat_window_1" style="margin-right:-1600px; margin-top:-75px;" >
     ...
     <form class="form-horizontal" role="form"><br>
      ...
      <div class="info">
          <br>
             <div class="row msg_container base_receive about">
                          <div class="col-md-2 col-xs-2 avatar">
                            <img src="../experiment/Mira.svg" class="img-responsive chat-image">
                        </div>
                        <div class="">
                            <div class="messages msg_receive">
                                 <p>I'm Miracle's innovation research associate a bot that helps to explore our new technologies <br>
                                 <span class="chat-info">
                                     <button type="button" class="btn btn-danger btnsub1"  style="padding: 3px 10px!important;margin-top: 6px;font-size:12px;font-weight:600;" >About Miracle</button><br>
                                    <button   type="button" class="btn btn-danger btnsub1"  style="padding: 3px 10px!important;margin-top: 6px;font-size:12px;font-weight:600;" >Job Search</button><br>
                                     <button  type="button" class="btn btn-danger btnsub1"   style="padding: 3px 10px!important;margin-top: 6px;font-size:12px;font-weight:600;" >Library Search</button><br>
                                      <button type="button" class="btn btn-danger btnsub1"  style="padding: 3px 10px!important;margin-top: 6px;font-size:12px;font-weight:600;">something else</button>
                                     </span>
                                 </p>
                            </div>
                        </div>
       ...
       <!--   <button onclick="ra(); return false;" class="col-sm-12 btn btn-info btnsub1" style="color:#ffffff;" id="play">about us</button>  <br/> -->
      </div>
