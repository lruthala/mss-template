...
/* back, initially hidden pane */
 .back {
  ...
  <link href="http://cdnjs.cloudflare.com/ajax/libs/foundation/5.3.3/css/foundation.min.css" rel="stylesheet" type="text/css">
<style>
...
$(function() {
  ...
  <body>
   ...
   <div class="row cover blur-in" id="overlay">
...
<div class="row pop-up"  id="slide-bottom-popup">
                       ...
                       <div class="row">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          ...
                          <button class="btn btn-primary btn-sm " onclick="document.querySelector('#flip-toggle').classList.toggle('hover');">
