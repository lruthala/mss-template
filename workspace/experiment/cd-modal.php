...
<html lang="en">
  <head>
    ...
    <!--Chisato script-->
    	<link rel="stylesheet" type="text/css" href="chisato/normalize.css" />
		<script src="chisato/classie.js"></script>
	
		<link rel="stylesheet" type="text/css" href="chisato/set2.css" />
  ...
  <body>
   ...
   <div class="row">
                ...
                <div class="col-sm-6 text-left">
                    <h1>
                        <strong>Enhanced MFT Visibility and Control</strong> with IBM Sterling Control Center
                    </h1>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <br>
                    <br>
                    <img class="img-responsive" src="../images/library/scc-archictecture.png" alt="SCC-Architecture" title="SCC Architecture">
                </div>
                <div class="col-sm-1"></div>
            </div>
            <div class="row">
                ...
                <p class="methodText greyText">
                 As our B2Bi and MFT experts give able guidance on how our Supply Chain Visibility Portal can help Global Enterprises gain critical visibility and control of their EDI Transactions. A live demo, architectural discussions followed by some great success stories make this a session that you do not want to miss. 
                  ...
                  <div class="row modal-footer">
                      <div class="col-sm-1"></div>
                 <div class="col-sm-5"><a href="../library/index.php"><button class="btn btn-primary col-sm-12">
                     <span> <i class="fa fa-arrow-left" ></i> </span>
                     Back To Library</button></a></div>
                  <div class="col-sm-5"> <button class="btn btn-primary col-sm-12" onclick="document.querySelector('#flip-toggle').classList.toggle('hover');">Access</button></div>
                  <div class="col-sm-1"></div>
                 </div>
                 </div>
                  </div> <!-- front part ends -->
                  ...
                  <div class="back" id="formDiv">
                   ...
                   <div class="modal-header">
                    ...
                    <!--copy 1 from contact first row starts-->
                      ...
                      <input class="form-control" style="width: 220px;" id="firstname" name="firstname" placeholder="First Name*" required="required" type="text">
                       </div>
                       </div>
                       <div class="col-sm-6">
                       <div class="form-group">
                         <input class="form-control" style="width: 220px;" placeholder="Last Name*" required="required" type="text">
                       </div>
                       </div>
                       </div>
                       <div class="row">
                        <div class="col-sm-6">
                        <div class="form-group">
                        <input class="form-control" style="width: 220px;" placeholder="Organization*" required="required" type="text">
                         </div>
                        </div>
                        <div class="col-sm-6">
                        <div class="form-group">
                         <input class="form-control" style="width: 220px;" placeholder="Designation*" required="required" type="text">
                         </div>
                          </div>
                          </div>
                          <div class="row">
                         <div class="col-sm-6">
                         <div class="form-group">
                          <input class="form-control" style="width: 220px;" placeholder="Email*" required="required" type="text">
                           </div>
                          </div>
                          <div class="col-sm-6">
                           <div class="form-group">
                           <input class="form-control" style="width: 220px;" placeholder="Work Phone*" required="required" type="text">
                           </div>
                            </div>
                           </div>
                            ...
                            <div class="col-sm-12">
                            <div class="form-group">
                            <button class="btn btn-primary col-sm-12" style="width: 460px;" id="btnSubmit" name="btnSubmit" tabindex="12" type="submit"> Submit </button>
                            </div>
                            </div>
                            </div>
                            ...
                            <div class="col-sm-6"><button class="btn btn-primary col-sm-12" onclick="document.querySelector('#flip-toggle').classList.toggle('hover');">
                           <span> <i class="fa fa-arrow-left" ></i> </span>
                           Back To Description
                          </button></div>
                   ...
                   <div class="tab-pane " id="emplyolee-sign-in">
                      ...
                      <input class="form-control" style="width: 220px;" id="firstname" name="firstname" placeholder="First Name*" required="required" type="text">
                        ...
                        <div class="col-sm-11"><button type="submit" tabindex="3" style="width: 220px;" class="btn btn-primary col-md-6" name="btnSubmit" id="btnSubmit">
                                    Log In
                                </button></div>
