...
#circle-shape-example .rightcurve { 
  width: 33%; height: auto;
  min-width: 150px;
  float: right;
  margin-left:2rem; 
                ...
                <div class="col-sm-10">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="overview">
                            ...
                            <center> <img src="../images/services/cloud-1.png" alt="cloud services"> </center>
                            <p class="methodText">
                        ...
                        <div class="tab-pane" id="Models">
                            ...
                            <div id="circle-shape-example">
                                 <img src="../images/services/cloud-2.png" alt="Certified Professionals" class="curve"><h1>Infrastructure as a Service (IaaS)</h1>
                                <p class="methodText">
                            ...
                            <div id="circle-shape-example">
                                 <img src="../images/services/cloud-3.png" alt="Certified Professionals" class="rightcurve"><h1>Platform as a Service (PaaS)</h1>
                                 <p class="methodText">
                            ...
                            <div id="circle-shape-example">
                                 <img src="../images/services/cloud-4.png" alt="Certified Professionals" class="curve"><h1>Software as a Service (SaaS)</h1>
                                  <p class="methodText">
