                ...
                <div class="col-sm-4">
                    ...
                    <div class="row">
                     <div class="row">
                        ...
                        <div class="row">
                          <div class="col-sm-12"> <a type="button" class="btn btn-primary col-sm-12" >Submit</a></div>
                           </div>
                          <div class="row">
                            <div class="col-sm-6"> <a type="button" class="btn btn-primary col-sm-12"  onClick="parent.location='https://www.linkedin.com/uas/oauth2/authorization?client_id=7549243mmah4kj&redirect_uri=https%3A//mss-templete-sivanmyc.c9.io&scope=r_emailaddress%20w_share&state=hTyHdealfpPhDtOUEmD23NdsSnEtsqkT&response_type=code'">SignIn with LinkedIn</a> </div>
                            <div class="col-sm-6">
                              <!-- <center><a href="#myModal" role="button" id="myModal" data-toggle="modal" class="btn btn-primary col-sm-12">Employee Login</a></center>-->
                                <button type="button" class="btn btn-primary col-sm-12" data-toggle="modal" data-target="#myModal">
                                 Employee Login
                                </button>
                                   </div>  
                         ...
                         <div class="row">
                             <div class="col-sm-4">
                                  <input type="button" value="Login" data-dismiss="modal" tabindex="3" class="btn btn-primary col-sm-12" name="btnSubmit1" id="btnSubmit1" onclick="doSubmit();" style="margin-left:0px;">
                                ...
                                <div id="collapseThree" class="panel-collapse collapse">
                                  <div class="row">
                                    <div class="panel-body">
                                       <div class="col-sm-8">
                                           <div class="form-group">
                                                <input class="form-control" placeholder="LoginId"  type="text">
                                            </div>
                                            <div class="form-group">
