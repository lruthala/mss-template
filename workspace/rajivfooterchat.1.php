...
<div onclick="viewSomething()" class="try" style="width:130px!important;">
  <span class="textual"><div class="shouldrotate"><img src="/experiment/Mira-200-200.png" style="height: 70px;"></div></span>
</div>
</div>
...
$('.try').click(function() {
    ...
    if (clicks == 0){
        ...
        function function2(){
            ...
            $('.textual').html('<div class="shouldrotate"><img src="/experiment/Mira-X.png" style="height:70px;"></div>');
        } clicks++;
        ...
        $('#chat_window_1').animate({"margin-right": '-1600'});
         ...
         $('.shouldrotate').promise().then(function4);
           function function3(){
            $('.textual').html('<div class="shouldrotate"><img src="/experiment/Mira- (1).png" style="height:70px;"></div>');
        }
