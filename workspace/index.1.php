                         ...
                         <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                     <div style="margin-top: 35px;" class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">Mulesoft Summit - Chicago
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">Chicago, IL 
                                        </h3>
                                        <p class="heavy animation animated-item-3">Join us September 7th , 2017    
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.mulesoftevents.com/events/mulesoft-summit-chicago-2017/event-summary-28d48ee95fb8494f83bfe3bf705c9f97.aspx">Register Now</a>
                                        <br><br>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                    <div class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">Exploring SAP Fiori 2.0 - An Award Winning UX for delightful customer experiences 
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">
                                        </h3>
                                        <p class="heavy animation animated-item-3 ">Online Webinar 
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.miraclesoft.com/webinars/exploring-sap-fiori-2-0-an-award-winning-ux-delightful-customer-experiences">Check Now</a>
                                        <br><br>
                                    </div>
                                </div>
                                <div class="col-sm-1 hidden-xs animation animated-item-4">
                     ...
                     <div class="item  img-responsive" style="background-image: url(images/slider/banner3.png)">
                       <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                    <div class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">Exploring RabbitMQ and Message Oriented <br>Middleware
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">The Laboratory Video
                                        </h3>
                                        <p class="heavy animation animated-item-3 "> 
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.miraclesoft.com/library/video/exploring-rabbitmq-and-message-oriented-middleware">Check Now</a>
                                        <br><br>
                                    </div>
                                </div>
                                <div class="col-sm-1 hidden-xs animation animated-item-4">
                     ...
                     <div class="item  img-responsive" style="background-image: url(images/slider/banner2.png)">
                       <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                    <div class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">Our Experiences creating Miracle's Private Cloud <br>with OpenStack 
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">Technical Article
                                        </h3>
                                        <p class="heavy animation animated-item-3 ">
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.miraclesoft.com/library/TechnicalArticle/privatecloud-on-openstack.php">Check Now</a>
                                        <br><br>
                                    </div>
                                </div>
                                <div class="col-sm-1 hidden-xs animation animated-item-4">
