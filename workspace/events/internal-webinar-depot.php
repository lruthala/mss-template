...
<div class="row">
        ...
        <div class="row">
                <div class="col-sm-4 ">
                    ...
                    <div align="left" class="greyText">With over 10,000 products in their catalog and a global presence demanding 1800 employees and 49 distribution centers for their 11,000 customer base...| <a href="#"><button class="btn btn-primary btn-md" type="button">Watch Video</button></a> </div>
                    </div>
                </div>
                <div class="col-sm-4 ">
                    <div class="row"></div>
                ...
                <div class="col-sm-4 ">
                    ...
                    <div align="left" class="greyText">Our customer is a financial holding company with investments primarily in companies focused on providing financial services. The migration process req...| <a href="#"><button class="btn btn-primary btn-md" type="button">Watch Video</button></a> </div>
                    </div>
                </div>
	...
	<button class="btn btn-md col-sm-12 btn-primary"><span class="glyphicon glyphicon-refresh glyphicon-refresh-animate"></span> Loading...</button>
</div>
            <br>
        <div class="row">
