          ...
          <img src="/events/microsoft-ignite-17/images/Satya.jpg" alt="Satya" class="img-responsive"  height="100%" width="100%" ></img>
           <a > <div class="widget-content themed-background text-light-op" style="background-color:rgba(140,140,140,0.15) !important;padding:15px;width:100%;border-bottom: 5px solid #ef4048;">
                   <center><strong><font color="#000000">Satya Nadella</font></strong></center>
                    <center><font color="#000000">Chief Executive Officer, Microsoft <br><br> </font></center>
                  </div> </a>
          </div>
          <div class="col-sm-3">
         ...
         background-size: cover; 
              ...
              height:75px;background-color:#2368a0;color:#fff;
               ...
               <a href="#" class="list-group-item-1">
                  <div>
                   <p class="methodText"> <center><strong><font size="3%!important" color="#fff"  onMouseOut="this.style.color='#fff'" onMouseOver="this.style.color='#b7b2b3'">&nbsp; Miracle @ Microsoft Ignite
                        </font></strong>
                     </center></p>
                  </div>
               </a>
               ...
               <div >
                  <div class="widget-content themed-background text-light-op" style="background-color:#00aae7;height:42px;">
                     <center style="padding-top:9px;"><strong><font style="color:#ffffff;">Upcoming Events</font></strong></center>
                  </div>
          ...
          height:120px;
                        ...
                        <center>
                           <a href="#">
                              ...
                              <h3 style="padding-top:19px;color:#ffffff !important;" class="heavy">Microsoft Ignite</h3>
                              <p style="padding-top:0px;"><font font-size="14px"color="#fff"><strong>September 25 - 29, 2017 in Orlando, Florida</strong></font></p>
                           </a>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="https://www.microsoft.com/en-us/ignite" target="_blank">
                        <center  style="padding-top:10px;"><strong><font style="color:#ffffff;" onMouseOut="this.style.color='#fff'" onMouseOver="this.style.color='#b7b2b3'">Register</font></strong></center>
                     </a>
                  </div>
                  </a>
               </div>
...
<center> <h1>Join us at Microsoft Ignite</h1>
               <h3 style="color:#eeeeee !important">September 25 - 29, 2017 in Orlando, Florida</h3>
               </center>
</div>
</div>    
</div> 
...
<div class="row">
   ...
   <div class="">
            ...
            <div class="col-sm-4">
        <div class="img1">
        <img class="img-responsive" src="/events/microsoft-ignite-17/images/microsoft3.jpg" alt="Experience Future Tech" >
           </div>
           <div style="background-color: rgba(140, 140, 140, 0.09) ! important;">
            ...
            <div class="col-sm-4 ">
            <div class="img2"> 
            <img class="img-responsive" src="/events/microsoft-ignite-17/images/microsoft2.jpg" alt="chat bots and self-cars">
            </div>
            <div style="background-color:rgba(140,140,140,0.09) !important;">
         ...
         <div class="widget-content  text-dark register-hover" style="margin-top:-10px;" >
            ...
            <div class="col-sm-4">
            <div class="img3">
             <img class="img-responsive" src="/events/microsoft-ignite-17/images/microsoft1.jpg" alt="Experts Speak!">
            </div>
             <div style="background-color:rgba(140,140,140,0.09) !important;">
