...
<head>
  ...
  <section id="interconnect" >
        ...
        <div class="container">
           <div class="row"> <br>
              <div class="col-sm-8 text-left">
                  <h1 class="heavy">Miracle @ Microsoft Ignite'17</h1>
              </div>
    ...
    <div class="container">
        ...
        <div class="row">
           <center><img src="/events/microsoft-ignite-17/images/implementation.png"></center>
        </div>
    </div>
        <div class="parallax">
            <div class="row banner"> 
                ...
                <center> 
                 <h1>Join us at Microsoft Ignite @Booth #2069</h1>
                 <h3 style="color:#eeeeee !important">Orlando, Florida</h3><br>
              ...
              <div class="row">
                   ...
                   <center> 
                     ...
                     <center>
                          <div class="col-sm-2">
                              ...
                              <h5 style="color:#eeeeee !important" class="heavy">Pankaj Lahoti</h5>
                ...
                <center> 
                    <div class="col-sm-2">
                     ...
                     <center> 
                    <div class="col-sm-2">
                        <i class="fa fa-user-circle fa-5x" style="color:#ffffff !important;font-size:120px !important;" aria-hidden="true"></i>
             <h5 class="heavy" style="color:#eeeeee !important" >John Deo</h5>
                         <p class="designation" style="margin-top:-5px;">Designation</p>
                    </div>
                </center>
    ...
    <div class="container">
        <div class="row">
           <center><img src="/events/microsoft-ignite-17/images/states1.png"></center>
        </div>
        <div class="row">
            <div class="col-sm-12">
               <div class="">
            ...
            <div class="col-sm-3">
           <div class="img1">
            <img class="img-responsive" src="/events/microsoft-ignite-17/images/Areas-of-Interest.jpg" alt="Experience Future Tech" style="width:100%;">
           </div>
           <div style="background-color: rgba(140, 140, 140, 0.09) ! important;">
            <h5 class="heavy noMarginTop" style="padding: 9px 16px 0px 16px;">Machine learning and deep learning techniques</h5>
            <hr class="bord">
            <p class="methodText"  style="padding: 3px 18px 10px 16px;">Explore the latest machine learning and deep learning techniques with Azure Machine Learning, Microsoft R Server and the Microsoft Data Science VM <br>.</p>
            ...
            <div style="background-color:rgba(140,140,140,0.09) !important;">
             <h5 class="heavy noMarginTop" style="padding: 9px 16px 0px 16px;">Cognitive services and bot framework</h5>
               <hr class="bord">
              <p class="methodText" style="padding: 3px 16px 10px 16px;">Enhance your current skills by learning to use intelligent APIs with Microsoft Cognitive Services and Bot Framework. Build and deploy a new generation of applications.</p>
             </div>
         <div class="widget-content  text-dark register-hover" style="margin-top:-10px;" >
            ...
            <div class="col-sm-3">
            <div class="img3">
             <img class="img-responsive" src="/events/microsoft-ignite-17/images/rob2.png" alt="Experts Speak!" style="width:100%;">
            </div>
             <div style="background-color:rgba(140,140,140,0.09) !important;">
             <h5 class="heavy noMarginTop" style="padding: 9px 16px 0px 16px;">End-to-end integrated production</h5>
             <hr class="bord">
             <p class="methodText" style="padding: 3px 16px 10px 16px;">Discover how to leverage the seamless integration within data services like Azure Data Factory, Azure HDInsight and Azure Data Lake to automate production systems.</p>
             </div>
             <div class="widget-content  text-dark register-hover" style="margin-top:-10px;">
                     <a class="linkText1" href="#" target="_blank">
           ...
           <div style="background-color: rgba(140, 140, 140, 0.09) ! important;">
            <h5 class="heavy noMarginTop" style="padding: 9px 16px 0px 16px;">Open source tools and technologies</h5>
            <hr class="bord">
            <p class="methodText"  style="padding: 3px 18px 30px 16px;">Learn to build intelligent applications with flexible open tools on our trusted data platform.<br><br><br></p>
            <div class="widget-content  text-dark register-hover" style="margin-top:-10px;">
                     <a class="linkText1" href="#">
                        <center style="padding-top:13px;"><strong><font style="color:#ffffff;" onmouseout="this.style.color='#fff'" onmouseover="this.style.color='#b7b2b3'">Explore the show case</font></strong></center>
                     </a>
