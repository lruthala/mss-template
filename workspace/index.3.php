...
<html lang="en">
    ...
    <?php include 'version-3.0/sap/mheader.2.php';?>
    <body>
       <style type="text/css">
...
.glyphicon{
                         ...
                         <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                     <div style="margin-top: 35px;" class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">The 7 Best Practices for building your own Enterprise<br> Chat Bot
                                        </h1>
                                        <p class="heavy animation animated-item-3">Technical Article 
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.miraclesoft.com/library/TechnicalArticle/7-bestpractices-building-your-own-chat-bot.php">Read More</a>
                                        <br><br>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                    <div class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">Any App, Any Database, Any Cloud! - Managing Multi-Cloud with Morpheus Data
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">
                                        </h3>
                                        <p class="heavy animation animated-item-3 ">On Demand Webinar
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.miraclesoft.com/events/webinar-after.php?eventId=207">Check Now</a>
                                        <br><br>
                                    </div>
                                </div>
                                <div class="col-sm-1 hidden-xs animation animated-item-4">
                     ...
                     <div class="item  img-responsive" style="background-image: url(images/slider/banner3.png)">
                       <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                    <div class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">Testing-as-a-Service - Simple, On-Demand and <br>Pay-as-you-go Model
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">
                                        </h3>
                                        <p class="heavy animation animated-item-3 ">On Demand Webinar
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.miraclesoft.com/events/webinar-after.php?eventId=221">Check Now</a>
                                        <br><br>
                                    </div>
                                </div>
                                <div class="col-sm-1 hidden-xs animation animated-item-4">
                     ...
                     <div class="item  img-responsive" style="background-image: url(images/slider/banner3.png)">
                       <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                    <div class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">Optimizing your SAP Solution Portfolio with Hybris B2B Solutions <br>and Ariba 
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">
                                        </h3>
                                        <p class="heavy animation animated-item-3 ">Online Webinar
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.miraclesoft.com/webinars/optimizing-your-sap-solution-portfolio-hybris-b2b-solutions-ariba">Register Now</a>
                                        <br><br>
                                    </div>
                                </div>
                                <div class="col-sm-1 hidden-xs animation animated-item-4">
    ...
    <div class="carousel-inner">
                 ...
                 <div class="item  active img-responsive" style="background-image: url(images/slider/banner4.png);background-repeat:no-repeat;background-size:cover;">
                       <div class="container">
                         <div class="row">
                                <div class="col-sm-1"></div>
                                <div class="col-sm-10" style="margin-top: 10px;">
                    ...
                    <div class="item  img-responsive" style="background-image: url(images/slider/banner1.png);background-repeat:no-repeat;background-size:cover;">
                       <div class="container">
                            <div class="row">
                                <div class="col-sm-1"></div>
                                <div class="col-sm-10" style="margin-top: 10px;">
                     ...
                     <div class="item  img-responsive" style="background-image: url(images/slider/banner3.png);background-repeat:no-repeat;background-size:cover;">
                       <div class="container">
                            <div class="row">
                                <div class="col-sm-1"></div>
                                <div class="col-sm-10" style="margin-top: 10px;">
                     ...
                     <div class="item  img-responsive" style="background-image: url(images/slider/banner3.png);background-repeat:no-repeat;background-size:cover;">
                       <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                    <div class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">Optimizing your SAP Solution Portfolio with Hybris B2B Solutions and Ariba 
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">
                                        </h3>
                                        <p class="heavy animation animated-item-3 ">Online Webinar
