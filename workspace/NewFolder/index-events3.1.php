				...
				<div class="container clearfix">
					...
					<div class="col_three_fifth bothsidebar nobottommargin">
						...
						<div id="posts" class="events small-thumbs">
							...
							<div class="entry clearfix" style="margin-bottom:0px !important;">
								<div class="entry-image hidden-sm">
									<a href="#">
...
<div class="dark" style="padding: 60px 0; background-image:linear-gradient(rgba(0, 0, 0, 0.85),rgba(0, 0, 0, 0.85) ), url('images/parallax/12.jpg');
	background-repeat: repeat-y; height: auto;background-size:cover" data-stellar-background-ratio="0.3">
					...
					<div class="container clearfix">
						...
						<div class="events-calendar">
							<div class="events-calendar-header clearfix">
								...
								<h2 style="color:#ffffff!important;font-size:28px!important;margin-top:0px;">Events Calendar of July</h2>
