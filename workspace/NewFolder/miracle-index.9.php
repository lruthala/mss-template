						...
						<div class="swiper-slide dark swiper-slide-active" style="background-image: url(../images/carousel/summint.png); height: 494px; width: 1263px;">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center" style="transform: translateY(0px); opacity: 1; top: 164px;">
									<h2 data-caption-animate="fadeInUp" class="fadeInUp animated">Microsoft Tech Summit</h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200" class="fadeInUp animated">March 05-06, 2018 | Washington D.C.</p>
								<div class="reg" style="margin-top:26px;">	<center><a href="https://www.microsoft.com/en-us/techsummit/washington-dc"><button type="button" class="btn btn-transparent btn-lg">Register</button></a></center></div>
								</div>
							</div>
						</div>
							...
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center" style="transform: translateY(0px); opacity: 1; top: 164px;">
									<h2 data-caption-animate="fadeInUp" class="not-animated" style="font-size: 28px !important;line-height: 50px;margin-bottom: 10px;">Agile Development Strategies to Sterling Integrator with IBM Urbancode Deploy and Docker Containers</span></h2>
						...
						<div class="swiper-slide" style="background-image: url(images/miracle/partnership.png); background-position: center top; height: 494px; width: 1263px;background-color: rgba(0, 170, 231, 0.32);">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center" style="transform: translateY(0px); opacity: 0.4; top: 127px;">
									<h2 data-caption-animate="fadeInUp" class="not-animated"><span style="font-size:28px !important; color:#ffffff !important;">DataStage and UNIX Platform Migration for a Leading Financial Enterprise</span></h2>
				...
				<br>
					...
					<div class="container" style="padding-bottom:25px;">
						<div class="row" style="text-align:center;">
								<div class="heading-block center bottommargin-lg" style="position:relative;margin-top:15px !important;">
						...
						<div class="row"  style="text-align:center;">
						<p>With growth and expansion on the minds of every Miraclite, we are hiring fresh talent rapidly all over India.The only qualification for you to join us is to have the right passion.</p>	
						</div>
						</br>
						<div id="jobcards">
						<div class="row">
							<div class="col-sm-4" id="diveffect">
								<div class="row">
									<div class="col-sm-1"></div>
									<div class="col-sm-3" style="padding-top:11px;">
										<img src="/version-3.0/data-services/images/Software-01.png">
									</div>
									<div class="col-sm-7">
										<h4><strong>Jr. Software Engineer</strong></h4>
										<p style="font-size:">Miracle City IND Development</p>
									</div>
									<div class="col-sm-1"></div>
								</div>
							</div>
							
							<div class="col-sm-4" id="diveffect" style="margin-left:20px;margin-right:20px;">
								<div class="row">
									<div class="col-sm-1"></div>
									<div class="col-sm-3" style="padding-top:11px;">
										<img src="/version-3.0/data-services/images/Digital%20Content%20Creator-01.png">
									</div>
									<div class="col-sm-7">
										<h4><strong>Digital Content Creator</strong></h4>
										<p>Miracle City IND Marketing</p>
									</div>
									<div class="col-sm-1"></div>
								</div>
							</div>
							...
							<div class="col-sm-4" id="diveffect">
								<div class="row">
									<div class="col-sm-1"></div>
									<div class="col-sm-3" style="padding-top:11px;">
										<img src="/version-3.0/data-services/images/OMS-01.png">
									</div>
									<div class="col-sm-7">
										<h4><strong>Sterling OMS Consultant</strong></h4>
										<p>USA-Michigan Development</p>
									</div>
									<div class="col-sm-1"></div>
								</div>
							</div>
						...
						<div class="row" style="padding-top:10px;">
							<div class="col-sm-4" id="diveffect">
								<div class="row">
									<div class="col-sm-1"></div>
									<div class="col-sm-3" style="padding-top:11px;">
										<img src="/version-3.0/data-services/images/Systems%20Engineer-01.png">
									</div>
									<div class="col-sm-7">
										<h4><strong>Jr. Systems Engineer</strong></h4>
										<p>Miracle City IND Operations</p>
									</div>
									<div class="col-sm-1"></div>
								</div>
							</div>
							...
							<div class="col-sm-4" id="diveffect" style="margin-left:20px;margin-right:20px;">
								<div class="row">
									<div class="col-sm-1"></div>
									<div class="col-sm-3" style="padding-top:11px;">
										<img src="/version-3.0/data-services/images/Human%20Resources%20Executive_1.png">
									</div>
									<div class="col-sm-7">
										<h4><strong>Human Resources Executive</strong></h4>
										<p>Miracle Heights Operations</p>
									</div>
									<div class="col-sm-1"></div>
								</div>
							</div>
							...
							<div class="col-sm-4" id="diveffect">
								<div class="row">
									<div class="col-sm-1"></div>
									<div class="col-sm-3" style="padding-top:11px;">
										<img src="/version-3.0/data-services/images/us%20it-01.png">
									</div>
									<div class="col-sm-7">
										<h4><strong>Sr.US - IT Recruiter </strong></h4>
										<p>Miracle City Development</p>
									</div>
									<div class="col-sm-1"></div>
								</div>
							</div>
						...
						<div class="row" style="padding-top:10px;">
							<div class="col-sm-4" id="diveffect">
								<div class="row">
									<div class="col-sm-1"></div>
									<div class="col-sm-3" style="padding-top:11px;">
										<img src="/version-3.0/data-services/images/PROJECT%20MANAGEMENT-01.png">
									</div>
									<div class="col-sm-7">
										<h4><strong>Project Management</strong></h4>
										<p>Miracle Heights Project Management</p>
									</div>
									<div class="col-sm-1"></div>
								</div>
							</div>
							...
							<div class="col-sm-4" id="diveffect" style="margin-left:20px;margin-right:20px;">
								<div class="row">
									<div class="col-sm-1"></div>
									<div class="col-sm-3" style="padding-top:11px;">
										<img src="/version-3.0/data-services/images/ApigeeDeveloper.png">
									</div>
									<div class="col-sm-7">
										<h4><strong>Apigee API Gateway Developer</strong></h4>
										<p>USA Development</p>
									</div>
									<div class="col-sm-1"></div>
								</div>
							...
							<div class="col-sm-4" id="diveffect">
								<div class="row">
									<div class="col-sm-1"></div>
									<div class="col-sm-3" style="padding-top:11px;">
										<img src="https://mss-templete-sivanmyc.c9.io/version-3.0/data-services/images/informatica-01.png">
									</div>
									<div class="col-sm-7">
										<h4><strong>Informatica Developer</strong></h4>
										<p>USA Development</p>
									</div>
									<div class="col-sm-1"></div>
								</div>
