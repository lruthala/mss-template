                         ...
                         <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                      <div style="margin-top: 35px;" class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">Great Lakes Business Intelligence and Big Data Summit
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">Troy, Michigan 
                                        </h3>
                                        <p class="heavy animation animated-item-3 " style="margin-top:-9px">March 30 , 2017 
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.greatlakesbisummit.com/2017/">Register</a>
                                        <br><br>
                                    </div>
                                </div>
                   ...
                   <div class="item  img-responsive" style="background-image: url(images/slider/banner1.png)">
                       <div class="container">
                         <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                   <div style="margin-top: 35px;" class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">MuleSoft Connect 
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">Connect anything. Change everything.
                                        </h3>
                                        <p class="heavy animation animated-item-3 " style="margin-top:-9px">April 18-20, 2017 | San Francisco
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="https://connect.mulesoft.com/">Register</a>
                                        <br><br>
                                    </div>  
                                </div>
                                <div class="col-sm-1 hidden-xs animation animated-item-4">
                    ...
                    <div class="item img-responsive" style="background-image: url(images/slider/banner3.png)">
                       <div class="container">
                         <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                      <div style="margin-top: 35px;" class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">SAP Sapphire Asug Annual Conference
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">Orlando, Florida
                                        </h3>
                                        <p class="heavy animation animated-item-3 " style="margin-top:-9px">May 16-18, 2017
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://events.sap.com/sapandasug/en/home">Register</a>
                                        <br><br>
                                    </div>
                                </div>
                                <div class="col-sm-1 hidden-xs animation animated-item-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                    <div class="carousel-content centered">
                                        ...
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.miraclesoft.com/events/webinar-after.php?eventId=207">Read More</a>
                                        <br><br>
                                    </div>
                                </div>
                                <div class="col-sm-1 hidden-xs animation animated-item-4">
