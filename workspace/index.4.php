                         ...
                         <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                     <div style="margin-top: 35px;" class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">Microsoft Ignite - Orlando
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">Meet us @Booth #2069
                                        </h3>
                                        <p class="heavy animation animated-item-3">September 25-29, 2017   
                                        </p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 10px;">
                                    <div class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">DevOps with MuleSoft Anypoint Platform - Managing the API Life Cycle  
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">Webinar 
                                        </h3>
                                        <p class="heavy animation animated-item-3 ">
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.miraclesoft.com/webinars/devops-mulesoft-anypoint-platform-managing-api-life-cycle">Register Today</a>
                                        <br><br>
                                    </div>
                                </div>
                                <div class="col-sm-1 hidden-xs animation animated-item-4">
                       ...
                       <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 6px;">
                                    <div class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">The Life of a CxO when Alexa and SAP become <br>Best Friends 
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">Laboratory Video
                                        </h3>
                                        <p class="heavy animation animated-item-3 "> 
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.miraclesoft.com/library/video/life-cxo-when-alexa-and-sap-become-best-friends.php">Watch Now</a>
                                        <br><br>
                                    </div>
                                </div>
                                <div class="col-sm-1 hidden-xs animation animated-item-4">
                       ...
                       <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-10" style="margin-top: 7px;">
                                    <div class="carousel-content centered">
                                        <h1 class="heavy animation animated-item-1">Contextual Mobile Experiences with <br>IBM Mobile First 
                                        </h1>
                                        <h3 class="heavy animation animated-item-2">Tech Article
                                        </h3>
                                        <p class="heavy animation animated-item-3 ">
                                        </p>
                                        <a class="btn btn-md animation animated-item-4" target="_blank" href="http://www.miraclesoft.com/library/TechnicalArticle/contextual-mobile-experiences.php">Reach Now</a>
                                        <br><br>
                                    </div>
                                </div>
                                <div class="col-sm-1 hidden-xs animation animated-item-4">
