...
<div onclick="viewSomething()" class="try" style="width:130px!important;">
  <span class="textual"><div class="shouldrotate"><img src="/experiment/Mira-200-200.png" style="height: 120px;padding-bottom:2em;"></div></span>
</div>
</div>
...
$('.try').click(function() {
    ...
    if (clicks == 0){
         ...
         function1(); 
         $('.shouldrotate').promise().then(function2);
         
         function function1(){
            //  $(".shouldrotate").removeClass("up");
             //  $(".shouldrotate").addClass("down");
               $('.shouldrotate').toggleClass("down").delay(300); 
         }
        function function2(){
            // $('.textual').html('<div class="shouldrotate"><img src="/experiment/Mira-200-200-X2.png" style="height:120px;padding-bottom:2em;"></div>');
            $('.textual').html('<div class="shouldrotate"><img src="/experiment/Mira-X.png" style="height:105px;padding-bottom:1em;"></div>');
        } clicks++;
        ...
        $('#chat_window_1').animate({"margin-right": '-1600'});
         ...
         function3();
         $('.shouldrotate').promise().then(function4);
           function function3(){
            $('.textual').html('<div class="shouldrotate"><img src="/experiment/Mira- (1).png" style="height:105px;padding-bottom:1em;"></div>');
        }
        
          function function4(){
            //   $(".shouldrotate").removeClass("down");
            //   $(".shouldrotate").addClass("up");
              
               $('.shouldrotate').toggleClass("down").delay(500); 
         }
